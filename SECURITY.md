# Segurança — debuga.ai Qwen Coder Lab
...
Este repositório é classificado como **experimental lab**. Exemplos, arquivos `.env.example`, Docker Compose e configurações devem ser tratados como referência e revisados antes de uso em ambientes controlados.
